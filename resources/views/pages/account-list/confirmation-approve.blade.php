        ...
        <form action="{{ route('account-request.approval', $user) }}" method="POST">
            ...
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title" id="approveModalLabel">Konfirmasi</h5>
                ...
                <div class="modal-body">
                    ...
                    <p class="mb-0">Apakah Anda yakin untuk mengaktifkan akun ini?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="submit" class="btn btn-success" id="confirmApprove">Aktifkan</button>
                </div>
            </div>
        </form>
    </div>
