        ...
        <form action="{{ route('account-request.approval', $user->id) }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mb-0">Apakah Anda yakin untuk menolak akun ini? Aksi ini tidak dapat dibatalkan.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                    <button type="submit" class="btn btn-outline-danger" id="confirmReject">Tolak</button>
                </div>
            </div>
        </form>
    </div>
