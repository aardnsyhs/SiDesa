                        ...
                        <div class="p-5">
                            ...
                            <form class="user" action="{{ route('register') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user @error('nik') is-invalid @enderror" id="nik" name="nik"
                                        placeholder="NIK (16 Digit)" value="{{ old('nik') }}">
                                    @error('nik')
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user @error('telepon') is-invalid @enderror" id="telepon"
                                        name="telepon" placeholder="Telepon" value="{{ old('telepon') }}">
                                    @error('telepon')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
